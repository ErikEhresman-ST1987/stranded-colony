...
const SAVE_VERSION=9,DB_NAME="stranded-colony",DB_VERSION=1,STORE_NAME="saves",ACTIVE_SAVE_KEY="active-colony";
let gameState=null;
const ui={};
...
function migrateGameState(candidate){
  if(candidate?.saveVersion===3||candidate?.saveVersion===4||candidate?.saveVersion===5||candidate?.saveVersion===6||candidate?.saveVersion===7||candidate?.saveVersion===8){
...
async function prepareSavedState(candidate){
  ...
  if(candidate?.saveVersion===3||candidate?.saveVersion===4||candidate?.saveVersion===5||candidate?.saveVersion===6||candidate?.saveVersion===7||candidate?.saveVersion===8)await SaveManager.writeActiveSave(migrated);
  return migrated
}
