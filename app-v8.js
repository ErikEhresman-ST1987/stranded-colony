...
function render(){
  ...
  if(hasState){
    ...
    const counts={shelter:0,salvage:0,forage:0,water:0,"survey-ridge":0,"investigate-ridge":0,"evaluate-spring":0};Object.values(p.assignments).forEach(id=>{if(id in counts)counts[id]++});
